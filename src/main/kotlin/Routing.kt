...
fun Application.configureRouting() {
    ...
    routing {
        ...
        // Route Rumah Adat
        route("/rumah-adat") {
            get { rumahAdatService.getAll(call) }
            post { rumahAdatService.create(call) }
            get("/{id}") { rumahAdatService.getById(call) }
            put("/{id}") { rumahAdatService.update(call) }
            delete("/{id}") { rumahAdatService.delete(call) }

            get("/{id}/image") { rumahAdatService.getImage(call) }
        }
